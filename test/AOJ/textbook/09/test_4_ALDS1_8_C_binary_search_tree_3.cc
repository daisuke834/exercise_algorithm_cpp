...
#include "src/AOJ/textbook/09/4_ALDS1_8_C_binary_search_tree_3.h"
...
TEST_F(Test_ALDS1_8_C, Node_Activate) {
  Node cnode;
  ASSERT_FALSE(cnode.IsValid());
  cnode.Activate();
...
TEST_F(Test_ALDS1_8_C, Node_SetKey) {
...
TEST_F(Test_ALDS1_8_C, Node_SetParent) {
...
TEST_F(Test_ALDS1_8_C, Node_SetChildLeft) {
  const int32_t kId = 12;
  Node cnode;
...
TEST_F(Test_ALDS1_8_C, Node_SetChildRight) {
...
TEST_F(Test_ALDS1_8_C, Node_GetNodeType) {
  Node cnode;
  ASSERT_ANY_THROW(cnode.GetNodeType());
  cnode.Activate();
  ASSERT_ANY_THROW(cnode.GetNodeType());
...
TEST_F(Test_ALDS1_8_C, NodeConstructors) {
  Node node_invalid;
...
TEST_F(Test_ALDS1_8_C, CallBinarySearchTree_Insert) {
...
TEST_F(Test_ALDS1_8_C, CallBinarySearchTree_Find) {
  std::ostringstream answer;
  answer << "yes" << std::endl;
  answer << "no" << std::endl;
  answer << " 1 12 17 20 25 30 88" << std::endl;
...
TEST_F(Test_ALDS1_8_C, CallBinarySearchTree_Delete_1) {
  std::ostringstream answer;
  answer << "yes" << std::endl;
  answer << "yes" << std::endl;
  answer << "no" << std::endl;
  ...
  answer << "yes" << std::endl;
  answer << "yes" << std::endl;
  answer << " 1 2 7 8 22" << std::endl;
  answer << " 8 2 1 7 22" << std::endl;
  answer << " 1 2 8 22" << std::endl;
  answer << " 8 2 1 22" << std::endl;

  std::ostringstream input_stream;
  input_stream << "16" << std::endl;
  input_stream << "insert 8" << std::endl;
  input_stream << "insert 2" << std::endl;
  input_stream << "insert 7" << std::endl;
  input_stream << "insert 22" << std::endl;
  input_stream << "insert 1" << std::endl;
  input_stream << "find 1" << std::endl;
  input_stream << "find 2" << std::endl;
  input_stream << "find 3" << std::endl;
  input_stream << "find 4" << std::endl;
  input_stream << "find 5" << std::endl;
  input_stream << "find 6" << std::endl;
  input_stream << "find 7" << std::endl;
  input_stream << "find 8" << std::endl;
  input_stream << "print" << std::endl;
  input_stream << "delete 7 " << std::endl;
  input_stream << "print" << std::endl;
  std::istringstream iss(input_stream.str());
  testing::internal::CaptureStdout();
  bool success = true;
...
TEST_F(Test_ALDS1_8_C, CallBinarySearchTree_2) {
  std::ostringstream answer;
  answer << "yes" << std::endl;
  answer << "no" << std::endl;
  answer << " 1 12 17 20 25 30 88" << std::endl;
...
TEST_F(Test_ALDS1_8_C, CallBinarySearchTree_Delete_3) {
  std::ostringstream answer;
  answer << "yes" << std::endl;
  answer << "yes" << std::endl;
  answer << "yes" << std::endl;
  ...
  answer << "yes" << std::endl;
  answer << "yes" << std::endl;
  answer << " 1 2 3 7 8 22" << std::endl;
  answer << " 8 2 1 3 7 22" << std::endl;
  answer << " 1 2 8 22" << std::endl;
  answer << " 8 2 1 22" << std::endl;

  std::ostringstream input_stream;
  input_stream << "18" << std::endl;
  input_stream << "insert 8" << std::endl;
  input_stream << "insert 2" << std::endl;
...
TEST_F(Test_ALDS1_8_C, CallBinarySearchTree_Delete_4) {
  std::ostringstream answer;
  answer << "yes" << std::endl;
  answer << "yes" << std::endl;
  answer << "yes" << std::endl;
  ...
  answer << " 1 2 3 7 8 22" << std::endl;
  answer << " 8 2 1 3 7 22" << std::endl;
  answer << " 1 3 7 8 22" << std::endl;
  answer << " 8 3 1 7 22" << std::endl;

  std::ostringstream input_stream;
  input_stream << "17" << std::endl;
  input_stream << "insert 8" << std::endl;
  input_stream << "insert 2" << std::endl;
  input_stream << "insert 3" << std::endl;
  input_stream << "insert 7" << std::endl;
  ...
  input_stream << "find 8" << std::endl;
  input_stream << "print" << std::endl;
  input_stream << "delete 2" << std::endl;
  input_stream << "print" << std::endl;
  std::istringstream iss(input_stream.str());
  testing::internal::CaptureStdout();
  bool success = true;
...
TEST_F(Test_ALDS1_8_C, GetNextNodeIndexInorder) {
  binary_search_tree_->Insert(8);
  binary_search_tree_->Insert(2);
  binary_search_tree_->Insert(7);
  binary_search_tree_->Insert(22);
  binary_search_tree_->Insert(1);
  ASSERT_EQ(0, binary_search_tree_->root_);
  const int32_t root = binary_search_tree_->root_;

  int32_t target_index;
  int32_t answer_next_index;
  int32_t returned_next_index;

  target_index = 0;
  answer_next_index = 3;
  returned_next_index = binary_search_tree_->GetNextNodeIndexInorder(root, target_index);
  ASSERT_EQ(answer_next_index, returned_next_index);
