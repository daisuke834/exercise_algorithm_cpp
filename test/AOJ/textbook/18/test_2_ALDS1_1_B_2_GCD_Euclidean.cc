...
#include "src/AOJ/textbook/18/2_ALDS1_1_B_2_GCD_Euclidean.h"
...
TEST_F(Test_ALDS1_1_B_2, CalculateGreatestCommonDivisor) { ASSERT_EQ(21, CalculateGreatestCommonDivisor(147, 105)); }
