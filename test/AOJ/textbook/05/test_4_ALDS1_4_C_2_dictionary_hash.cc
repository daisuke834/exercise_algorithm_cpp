 ...
 * @brief Part5-4. 探索、ハッシュ法のテスト。オープンアドレス法による実装。
...
#include "src/AOJ/textbook/05/4_ALDS1_4_C_2_dictionary_hash.h"

namespace ALDS1_4_C_2 {

class Test_ALDS1_4_C_2 : public ::testing::Test {
 protected:
  Dictionary* dictionary_;
  virtual void SetUp() { dictionary_ = nullptr; }
  virtual void TearDown() {}
};

TEST_F(Test_ALDS1_4_C_2, Key) {
  Key key_1("AAA");
  Key key_2("2");
...
TEST_F(Test_ALDS1_4_C_2, DataSize) {
...
TEST_F(Test_ALDS1_4_C_2, NoData) {
...
TEST_F(Test_ALDS1_4_C_2, WithData) {
  dictionary_ = new Dictionary();
...
TEST_F(Test_ALDS1_4_C_2, CallDictionary_1) {
...
TEST_F(Test_ALDS1_4_C_2, CallDictionary_2) {
  std::ostringstream answer;
  answer << "yes" << std::endl;
  answer << "no" << std::endl;
  answer << "no" << std::endl;
...
TEST_F(Test_ALDS1_4_C_2, CallDictionary_3) {
  std::ostringstream answer;
  answer << "yes" << std::endl;
  answer << "no" << std::endl;
  answer << "no" << std::endl;
