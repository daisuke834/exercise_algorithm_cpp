...
#include "src/AOJ/textbook/17/1_DPL_1_A_1_coin_changing_problem.h"

namespace DPL_1_A_1 {

class Test_DPL_1_A_1 : public ::testing::Test {
 protected:
...
TEST_F(Test_DPL_1_A_1, FindNumberOfMinimumNumberOfCoins_1) {
...
TEST_F(Test_DPL_1_A_1, FindNumberOfMinimumNumberOfCoins_2) {
  coin_chainging_problem_->AddCoinValue(1);
  coin_chainging_problem_->AddCoinValue(2);
  ASSERT_EQ(1, coin_chainging_problem_->FindNumberOfMinimumNumberOfCoins(2));
}

TEST_F(Test_DPL_1_A_1, FindNumberOfMinimumNumberOfCoins_3) {
  coin_chainging_problem_->AddCoinValue(1);
  coin_chainging_problem_->AddCoinValue(2);
  ASSERT_EQ(2, coin_chainging_problem_->FindNumberOfMinimumNumberOfCoins(3));
}

TEST_F(Test_DPL_1_A_1, FindNumberOfMinimumNumberOfCoins_4) {
  coin_chainging_problem_->AddCoinValue(1);
  coin_chainging_problem_->AddCoinValue(2);
...
TEST_F(Test_DPL_1_A_1, FindNumberOfMinimumNumberOfCoins_5) {
  coin_chainging_problem_->AddCoinValue(1);
  coin_chainging_problem_->AddCoinValue(2);
  coin_chainging_problem_->AddCoinValue(7);
  coin_chainging_problem_->AddCoinValue(8);
...
TEST_F(Test_DPL_1_A_1, CallCoinChangingProblem_1) {
