...
#include "src/AOJ/textbook/12/3_ALDS1_11_B_2_depth_first_search.h"
...
TEST_F(Test_ALDS1_11_B_2, CallDepthFirstSearch_2) {
  std::ostringstream answer;
...
TEST_F(Test_ALDS1_11_B_2, CallDepthFirstSearch_3) {
  std::ostringstream answer;
  answer << "1 1 8" << std::endl;
  answer << "2 2 7" << std::endl;
...
TEST_F(Test_ALDS1_11_B_2, ExploreAllVertices_1) {
...
TEST_F(Test_ALDS1_11_B_2, ExploreAllVertices_2) {
  depth_first_search_->AddVertex(1);
  depth_first_search_->MapDirection(1, 2);
