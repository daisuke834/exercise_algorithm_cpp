...
#include "src/AOJ/textbook/12/3_ALDS1_11_B_3_depth_first_search.h"

namespace ALDS1_11_B_3 {

class Test_ALDS1_11_B_3 : public ::testing::Test {
 protected:
...
TEST_F(Test_ALDS1_11_B_3, CallDepthFirstSearch_1) {
...
TEST_F(Test_ALDS1_11_B_3, CallDepthFirstSearch_2) {
  std::ostringstream answer;
...
TEST_F(Test_ALDS1_11_B_3, CallDepthFirstSearch_3) {
  std::ostringstream answer;
  answer << "1 1 8" << std::endl;
  answer << "2 2 7" << std::endl;
...
TEST_F(Test_ALDS1_11_B_3, ExploreAllVertices_1) {
  ...
  ASSERT_EQ(1, depth_first_search_->vertices_[vertex_index++].GetDiscoveredTime());
  ASSERT_EQ(2, depth_first_search_->vertices_[vertex_index++].GetDiscoveredTime());
  ASSERT_EQ(4, depth_first_search_->vertices_[vertex_index++].GetDiscoveredTime());
  ASSERT_EQ(3, depth_first_search_->vertices_[vertex_index++].GetDiscoveredTime());

  vertex_index = 0;
  ASSERT_EQ(8, depth_first_search_->vertices_[vertex_index++].GetCompletionTime());
  ASSERT_EQ(7, depth_first_search_->vertices_[vertex_index++].GetCompletionTime());
  ASSERT_EQ(5, depth_first_search_->vertices_[vertex_index++].GetCompletionTime());
  ASSERT_EQ(6, depth_first_search_->vertices_[vertex_index++].GetCompletionTime());
}

TEST_F(Test_ALDS1_11_B_3, ExploreAllVertices_2) {
  depth_first_search_->AddVertex(1);
  depth_first_search_->MapDirection(1, 2);
  ...
  ASSERT_EQ(2, depth_first_search_->vertices_[vertex_index++].GetDiscoveredTime());
  ASSERT_EQ(3, depth_first_search_->vertices_[vertex_index++].GetDiscoveredTime());
  ASSERT_EQ(9, depth_first_search_->vertices_[vertex_index++].GetDiscoveredTime());
  ASSERT_EQ(4, depth_first_search_->vertices_[vertex_index++].GetDiscoveredTime());
  ASSERT_EQ(5, depth_first_search_->vertices_[vertex_index++].GetDiscoveredTime());

  vertex_index = 0;
  ASSERT_EQ(12, depth_first_search_->vertices_[vertex_index++].GetCompletionTime());
  ASSERT_EQ(11, depth_first_search_->vertices_[vertex_index++].GetCompletionTime());
  ASSERT_EQ(8, depth_first_search_->vertices_[vertex_index++].GetCompletionTime());
  ASSERT_EQ(10, depth_first_search_->vertices_[vertex_index++].GetCompletionTime());
  ASSERT_EQ(7, depth_first_search_->vertices_[vertex_index++].GetCompletionTime());
  ASSERT_EQ(6, depth_first_search_->vertices_[vertex_index++].GetCompletionTime());
}
