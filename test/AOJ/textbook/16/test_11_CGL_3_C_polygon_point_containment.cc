...
#include "src/AOJ/textbook/16/11_CGL_3_C_polygon_point_containment.h"
...
class Test_CGL_3_C : public ::testing::Test {
 protected:
  virtual void SetUp() {}
  virtual void TearDown() {}
};

TEST_F(Test_CGL_3_C, Point2D_Constructors) {
...
TEST_F(Test_CGL_3_C, Point2D_Operators) {
...
TEST_F(Test_CGL_3_C, Point2D_Perpendicular) {
...
TEST_F(Test_CGL_3_C, IsParallel) {
...
TEST_F(Test_CGL_3_C, IsOrthogonal) {
...
TEST_F(Test_CGL_3_C, SegmentsAreCrossing_1) {
...
TEST_F(Test_CGL_3_C, GetCrossPointsWithLine_1) {
...
TEST_F(Test_CGL_3_C, GetCrossPointsWithLine_2) {
...
TEST_F(Test_CGL_3_C, GetCrossPointsWithCircle_1) {
...
TEST_F(Test_CGL_3_C, GetCrossPointsWithCircle_2) {
...
TEST_F(Test_CGL_3_C, GetCrossPointsWithCircle_3) {
...
TEST_F(Test_CGL_3_C, GetCrossPointsWithCircle_4) {
...
TEST_F(Test_CGL_3_C, IsOnSegment) {
...
TEST_F(Test_CGL_3_C, SegmentCrossesWithRightwardHalflineFromPoint) {
...
TEST_F(Test_CGL_3_C, AskContainment_1) {
  Polygon polygon;
...
TEST_F(Test_CGL_3_C, AskContainment_2) {
  Polygon polygon;
  polygon.AddVertex(Point2D(0.0, 0.0));
  polygon.AddVertex(Point2D(3.0, 1.0));
...
TEST_F(Test_CGL_3_C, CallPolygonPointContainment_1) {
  ...
  bool success = true;
  try {
    CallPolygonPointContainment(iss);
  } catch (...) {
    success = false;
  }
...
TEST_F(Test_CGL_3_C, CallPolygonPointContainment_2) {
  std::ostringstream answer;
  answer << "2" << std::endl;
  answer << "2" << std::endl;
  answer << "2" << std::endl;
...
TEST_F(Test_CGL_3_C, CallPolygonPointContainment_3) {
  std::ostringstream answer;
  answer << "2" << std::endl;
  answer << "2" << std::endl;
  answer << "2" << std::endl;
