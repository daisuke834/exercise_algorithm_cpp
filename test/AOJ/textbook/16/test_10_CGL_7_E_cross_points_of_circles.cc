...
#include "src/AOJ/textbook/16/10_CGL_7_E_cross_points_of_circles.h"
...
class Test_CGL_7_E : public ::testing::Test {
 protected:
  virtual void SetUp() {}
  virtual void TearDown() {}
};

TEST_F(Test_CGL_7_E, Point2D_Constructors) {
...
TEST_F(Test_CGL_7_E, Point2D_Operators) {
...
TEST_F(Test_CGL_7_E, Point2D_Perpendicular) {
...
TEST_F(Test_CGL_7_E, IsParallel) {
...
TEST_F(Test_CGL_7_E, IsOrthogonal) {
...
TEST_F(Test_CGL_7_E, SegmentsAreCrossing_1) {
...
TEST_F(Test_CGL_7_E, GetCrossPointsWithLine_1) {
...
TEST_F(Test_CGL_7_E, GetCrossPointsWithLine_2) {
...
TEST_F(Test_CGL_7_E, GetCrossPointsWithCircle_1) {
...
TEST_F(Test_CGL_7_E, GetCrossPointsWithCircle_2) {
...
TEST_F(Test_CGL_7_E, GetCrossPointsWithCircle_3) {
...
TEST_F(Test_CGL_7_E, GetCrossPointsWithCircle_4) {
...
TEST_F(Test_CGL_7_E, CallCrossPointsOfCircles) {
  const double answers[4] = {1.00000000, -1.73205080, 1.00000000, 1.73205080};

  std::ostringstream input_stream;
  input_stream << "0 0 2" << std::endl;
  input_stream << "2 0 2" << std::endl;
  std::istringstream iss(input_stream.str());

  testing::internal::CaptureStdout();
  bool success = true;
  try {
    CallCrossPointsOfCircles(iss);
  } catch (...) {
  ...
  const std::vector<double> results = utils::SplitStringToDoubleVector(result_lines[0], ' ');
  ASSERT_NEAR(answers[0], results[0], kEPS);
  ASSERT_NEAR(answers[1], results[1], kEPS);
  ASSERT_NEAR(answers[2], results[2], kEPS);
  ASSERT_NEAR(answers[3], results[3], kEPS);
}
