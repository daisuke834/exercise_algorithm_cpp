...
#include "src/AOJ/textbook/15/5_GRL_2_A_1_MST_Prim.h"

namespace GRL_2_A_1 {

class Test_GRL_2_A_1 : public ::testing::Test {
 protected:
  virtual void SetUp() {}
  virtual void TearDown() {}
};

TEST_F(Test_GRL_2_A_1, CallPrimAlgorithm_1) {
...
TEST_F(Test_GRL_2_A_1, CallPrimAlgorithm_2) {
  std::ostringstream answer;
  answer << "3" << std::endl;
...
TEST_F(Test_GRL_2_A_1, CallPrimAlgorithm_3) {
  std::ostringstream answer;
  answer << "0" << std::endl;
...
TEST_F(Test_GRL_2_A_1, CallPrimAlgorithm_4) {
  std::ostringstream answer;
