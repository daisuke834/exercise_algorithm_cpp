...
#include "src/LeetCode/200_2_number_of_islands_dfs.h"

namespace LC_200_2 {

class Test_LC_200_2 : public ::testing::Test {
 protected:
  virtual void SetUp() {}
  virtual void TearDown() {}
};

TEST_F(Test_LC_200_2, CallNumberOfIsland_1) {
...
TEST_F(Test_LC_200_2, CallNumberOfIsland_2) {
  std::ostringstream answer;
  answer << "3" << std::endl;
...
TEST_F(Test_LC_200_2, CallNumberOfIsland_3) {
  std::ostringstream answer;
  answer << "1" << std::endl;
