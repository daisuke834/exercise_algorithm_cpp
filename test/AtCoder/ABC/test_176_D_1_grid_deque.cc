...
#include "src/AtCoder/ABC/176_D_1_grid_deque.h"

namespace D_ABC_176_D_1 {

class Test_D_ABC_176_D_1 : public ::testing::Test {
 protected:
  virtual void SetUp() {}
  virtual void TearDown() {}
};

TEST_F(Test_D_ABC_176_D_1, test_1) {
...
TEST_F(Test_D_ABC_176_D_1, test_2) {
  std::ostringstream answer;
  answer << "-1" << std::endl;
...
TEST_F(Test_D_ABC_176_D_1, test_3) {
  std::ostringstream answer;
  answer << "0" << std::endl;
...
TEST_F(Test_D_ABC_176_D_1, test_4) {
  std::ostringstream answer;
  answer << "2" << std::endl;
