...
#include "src/AtCoder/ABC/167_D_2_teleporter_doubling.h"

namespace ABC_167_D_2 {

class Test_ABC_167_D_2 : public ::testing::Test {
 protected:
  virtual void SetUp() {}
  virtual void TearDown() {}
};

TEST_F(Test_ABC_167_D_2, CallTeleporter_1) {
...
TEST_F(Test_ABC_167_D_2, CallTeleporter_2) {
  std::ostringstream answer;
  answer << "2" << std::endl;
