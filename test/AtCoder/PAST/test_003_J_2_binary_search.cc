...
#include "src/AtCoder/PAST/003_J_2_binary_search.h"

namespace PAST_003_J_2 {

class Test_PAST_003_J_2 : public ::testing::Test {
 protected:
 protected:
  virtual void SetUp() {}
...
TEST_F(Test_PAST_003_J_2, test_1) {
...
TEST_F(Test_PAST_003_J_2, test_2) {
  std::ostringstream answer;
  answer << "1" << std::endl;
  answer << "1" << std::endl;
  answer << "2" << std::endl;
...
TEST_F(Test_PAST_003_J_2, test_3) {
  std::ostringstream answer;
  answer << "1" << std::endl;
  answer << "2" << std::endl;
  answer << "1" << std::endl;
