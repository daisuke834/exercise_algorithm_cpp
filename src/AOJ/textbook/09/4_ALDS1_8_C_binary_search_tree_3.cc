...
#include "4_ALDS1_8_C_binary_search_tree_3.h"
...
void Node::ResetChildLeft() noexcept { child_left_ = kInvalid; }

void Node::ResetChildRight() noexcept { child_right_ = kInvalid; }
