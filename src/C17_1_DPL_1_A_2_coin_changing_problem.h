...
#ifndef SRC_C17_1_DPL_1_A_2_COIN_CHANGING_PROBLEM_H_
...
class CoinChangingProblem {
 ...
 private:
  ...
  int32_t minimum_number_of_coins_[kMaxAmountOfPayment + 1];

 private:
  FRIEND_TEST(Test_DPL_1_A_2, dummy);  // Should be removed from production code
};

}  // namespace DPL_1_A_2

#endif  // SRC_C17_1_DPL_1_A_2_COIN_CHANGING_PROBLEM_H_
