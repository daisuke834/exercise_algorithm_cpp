...
#ifndef SRC_C09_2_ALDS1_8_A_BINARY_SEARCH_TREE_1_H_
#define SRC_C09_2_ALDS1_8_A_BINARY_SEARCH_TREE_1_H_
...
enum class InstructionType : int32_t { kInsert = 0, kPrint };
...
class Node {
 ...
 private:
  FRIEND_TEST(Test_ALDS1_8_A, NodeConstructors);  // Should be removed from production code
};
...
class BinarySearchTree {
 ...
 private:
  FRIEND_TEST(Test_ALDS1_8_A, BinarySearchTree_AddNode);  // Should be removed from production code
};

}  // namespace ALDS1_8_A

#endif  // SRC_C09_2_ALDS1_8_A_BINARY_SEARCH_TREE_1_H_
