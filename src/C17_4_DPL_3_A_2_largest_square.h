...
#ifndef SRC_C17_4_DPL_3_A_2_LARGEST_SQUARE_H_
...
class LargestSquare {
 ...
 private:
  int32_t height_;
  int32_t width_;
  int32_t length_to_upper_and_left_[kMaxHeight][kMaxWidth];

 private:
  FRIEND_TEST(Test_DPL_3_A_2, dummy);  // Should be removed from production code
};

}  // namespace DPL_3_A_2

#endif  // SRC_C17_4_DPL_3_A_2_LARGEST_SQUARE_H_
