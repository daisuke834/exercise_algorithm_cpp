...
#ifndef SRC_C17_3_DPL_1_D_3_LONGEST_INCREASING_SUBSEQUENCE_H_
#define SRC_C17_3_DPL_1_D_3_LONGEST_INCREASING_SUBSEQUENCE_H_
...
class LongestIncreasingSubsequence {
 ...
 private:
  FRIEND_TEST(Test_DPL_1_D_3, dummy);  // Should be removed from production code
};

}  // namespace DPL_1_D_3

#endif  // SRC_C17_3_DPL_1_D_3_LONGEST_INCREASING_SUBSEQUENCE_H_
